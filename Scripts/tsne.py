...
#     axes[0, 0].scatter(
#         teacher_tsne[indices, 0],
#         teacher_tsne[indices, 1],
#         s=10,
#         alpha=0.7,
...
#     axes[0, 1].scatter(
#         student_tsne[indices, 0],
#         student_tsne[indices, 1],
#         s=10,
#         alpha=0.7,
#         label=classes[class_idx]
#     )
...
#     axes[1, 0].scatter(
#         student_imp_tsne[indices, 0],
#         student_imp_tsne[indices, 1],
#         s=10,
#         alpha=0.7,
#         label=classes[class_idx]
#     )
...
# axes[1, 0].set_title(
#     "Student Improvised", fontsize=25
# )
...
# # plt.savefig("/export/home/achyut/Simarjeet/Unlearning/KD-MUL-CIFAR10/Plots/TSNE/PLOT.png")
# # plt.show()
...
#     axes[1, 1].scatter(
#         oracle_tsne[indices, 0],
#         oracle_tsne[indices, 1],
#         s=10,
#         alpha=0.7,
#         label=classes[class_idx]
#     )
...
# plt.savefig(
#     "/export/home/achyut/Simarjeet/Unlearning/KD-MUL-CIFAR10/Plots/TSNE/PLOT.png",
#     dpi=300,
#     bbox_inches="tight"
# )
...
fig, axes = GridSpec(
    2,
    5,
    figsize=(40, 16)   # wider figure for 6 plots
)
...
for class_idx in range(10):
    ...
    axes[0, 4].scatter(
        neggrad_tsne[indices, 0],
        neggrad_tsne[indices, 1],
        s=10,
        alpha=0.7,
        label=classes[class_idx]
    )
...
for class_idx in range(10):
    ...
    axes[1, 1].scatter(
        lcodec_tsne[indices, 0],
        lcodec_tsne[indices, 1],
        s=10,
        alpha=0.7,
        label=classes[class_idx]
    )
...
for class_idx in range(10):
    ...
    axes[1, 3].scatter(
        scrub_tsne[indices, 0],
        scrub_tsne[indices, 1],
        s=10,
        alpha=0.7,
        label=classes[class_idx]
    )
